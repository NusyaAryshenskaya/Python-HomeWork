...
def beat_in_text(text):                       
    vowels = "аяуюоеёэиы"
    sum_of_vowels = [sum(symb in vowels for symb in poem) for poem in text]
    if len(set(sum_of_vowels)) == 1:
        return ("Парам пам-пам")
    else:
        return ("Пам парам")


text = input("Введите кричалку Винни-Пуха: ").lower().split()
